...
<div class="container"  style="margin-top: 120px;">
    <div class="row">
      <div class="col-3">
        ...
        <h3 class="yournum"><?php echo $benum.$number; ?></h3>
      </div>
    </div>
  </div>
  <div class="container"> 
      ...
      <div class="col-md-6 col-lg-6 col-sm-12">
        <div class="userdet" style="display: block; margin-left: auto; margin-right: auto;">
          ...
          <form class="sform" action="{{ route('pay') }}" method="POST">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-12 col-lg-6">
                <label for="nationality">ملیت</label><br>
                <select class="input100"  name="nationality" id="nationality" required="">
              ...
              <div class="col-md-6 col-sm-12 col-lg-6">
                <label for="internet_service" style="text-align: right;">نوع سرویس اینترنت</label><br>
                <select class="input100"  name="internet_service" id="internet_service" required="">
                  <option value="adsl">ADSL</option>
                  <option value="dw">Dedicated Wireless</option>
                </select>
             </div>
            </div>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-lg-12">
                <label for="address">آدرس پستی</label><br>
                <input type="text" name="address" maxlength="100" class="input100" placeholder="آدرس پستی" required=""
                id="address" value="{{ old('address') ?? '' }}">
              </div>
            </div>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-lg-12">
                <label for="postal_code">کدپستی</label><br>
                <input type="text" name="postal_code" maxlength="100" class="input100" placeholder="کدپستی" required=""
            ...
            <div class="row">
              <div class="col-md-6 col-sm-12 col-lg-6">
                ...
                <input type="password" required name="password_confirmation" class=" input100" placeholder="تکرار کلمه‌عبور"
             ...
             <div class="col-md-6 col-sm-12 col-lg-6">
              ...
              <input type="password" required name="password" class=" input100" placeholder="کلمه‌عبور" id="id_password"
              style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: left center;">
            </div>
            </div>
            <div class="row">
